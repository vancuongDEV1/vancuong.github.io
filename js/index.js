...
// USER NAME + TÍCH XANH
document.getElementById("userName").innerHTML = 'Nguyễn Duy Khánh <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Twitter_Verified_Badge.svg/512px-Twitter_Verified_Badge.svg.png" width="17" height="17" alt="Tích Xanh">';
// CHECK FPS
...
let typed = new Typed(".GioiThieu", {
  strings: ["Hi my name is Duy Khánh","Hey brother, I'm a Developer.", "I like website design =]]"],
  typeSpeed: 95,
  backSpeed: 75,
  loop: true
})
...
toastDiv.id = 'Toast';
toastDiv.textContent = '𝘿𝙚𝙨𝙞𝙜𝙣 𝙗𝙮 𝑫 𝒖 𝒚 𝑲 𝒉 𝒂 𝒏 𝒉 =))';
